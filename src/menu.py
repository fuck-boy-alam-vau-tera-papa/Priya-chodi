...
###----------[ CHECK STATUS SCRIPT ]---------- ###
try:
	info = ses.get("https://github.com/fuck-boy-alam-vau-tera-papa/approval.txt/blob/main/approval.txt").text
...
[{color_rich}03{P2}]. I want to see the results crack""",width=80,padding=(0,15),style=f"{color_table}"))
	...
	if api in["1","01"]:
		...
		os.system("xdg-open https://wa.me/+8801712034653?text=assalamualaikum,+bang+saya+mau+beli+lisensi")
		sleep(2);menu_apikey()
	elif api in["3","03"]:
		Lain.see_results()
...
'\x1b[0;37m    _    _        _    __  __  ____ ___ ____  
'\x1b[0;37m    / \  | |      / \  |  \/  |/ ___|_ _|  _ \ 
'\x1b[0;37m  / _ \ | |     / _ \ | |\/| | |  _ | || |_) |
'\x1b[0;37m  / ___ \| |___ / ___ \| |  | | |_| || ||  _ < 
'\x1b[0;37m /_/   \_\_____/_/   \_\_|  |_|\____|___|_| \_\
'\x1b[0;37m  _____ _   _  ____ _  __  ____   _____   __   
'\x1b[0;37m |  ___| | | |/ ___| |/ / | __ ) / _ \ \ / /   
'\x1b[0;37m | |_  | | | | |   | ' /  |  _ \| | | \ V /    
'\x1b[0;37m |  _| | |_| | |___| . \  | |_) | |_| || |     
'\x1b[0;37m |_|    \___/ \____|_|\_\ |____/ \___/ |_|     
                                               

                         Made By {M2} FUCK BOY ALAMGIR TERA REAL PAPA {P2}Coder""",title=f"{P2}{waktu()}",style=f"{color_table}"))
